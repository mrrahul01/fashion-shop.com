...
<body>
<div>
<a href="index.php"> <img src="usepics/homebutton.png" alt="Mountain View" style="width:160px;height:80px;margin-left:480px; margin-top: 20px;"></a>
<div><br/><h2 style="margin-left:400px; margin-top: 20px;"><font face="Lucida Handwriting" size="+2" color="#00CCFF">Welcome 
<?php
...
<h2 align="right"><a href="LogOut.php?log=out"><font color="#0099FF">LogOut</font></a></h2>
</div>
