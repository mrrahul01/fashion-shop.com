...
<head>
<link rel="icon" href="usepics/favicon.png" type="image/gif" sizes="16x16">
<?php
error_reporting(1);
 include("index1.php");
 ob_start();
...
<div id="Bottom">
<p class="down"><b>Copyright &copy; Fashion Shop, Design by:<a href="https://www.facebook.com/rahul.khan.2095"> Md Ruhul Khan </a></b></p>
